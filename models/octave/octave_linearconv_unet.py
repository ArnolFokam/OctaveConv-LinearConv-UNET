...
class OctaveLinearConvUNet(UNetBackBone):
    ...
    def __init__(self,
                 ...
                 padding_mode='zeros',
                 merge_mode='padding'):
        super(OctaveLinearConvUNet, self).__init__(
            channels,
            kernel_size,
            stride,
            padding,
        ...
        i = 0
        for input_channel, output_channel, input_alpha, output_alpha, variant, ratio in zip(
                encoder_input_channels, encoder_output_channels,
                encoder_input_alphas, encoder_output_alphas, encoder_variants,
                encoder_ratios):
            i += 1
        ...
        for input_channel, output_channel, input_alpha, output_alpha, variant, ratio in zip(
                ...
                decoder_input_alphas, decoder_output_alphas, decoder_variants,
                decoder_ratios):
