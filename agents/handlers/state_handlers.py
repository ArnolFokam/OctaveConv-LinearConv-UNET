...
from agents.handlers.metrics_handler import MetricsHandler
from agents.handlers.graph_handler import GraphHandler
...
class StateHandler(GraphHandler, MetricsHandler):
    ...
    def save_agent_state(self, ckpt_path):
        ...
        ckpt_dict = {'epoch': self.current_epoch, 'step': self.current_step, 'monitors': self.monitors,
